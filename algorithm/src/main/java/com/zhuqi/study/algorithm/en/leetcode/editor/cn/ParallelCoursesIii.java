...
// 
//
// Related Topics 图 拓扑排序 数组 动态规划 👍 74 👎 0
...
public class ParallelCoursesIii {
    ...
    class Solution {
         ...
         * > 2023/07/28 17:53:37
         * Success:
         * Runtime:32 ms, faster than 51.11% of Java online submissions.
         * Memory Usage:77.3 MB, less than 11.11% of Java online submissions.
         *
         * @param n
         * @param relations
         * @param time
